...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        freedom_of_press_austria_ranking = [16, 16, 16, 14, 13, 7, 5, 5, 12, 12, 7, 11, 11, 11, 16, 18, 17, 31, 29]
        freedom_of_press_swiss_ranking = [1, 9, 11, 7, 7, 6, 8, 8, 14, 15, 20, 7, 7, 5, 6, 8, 10, 14, 12]
